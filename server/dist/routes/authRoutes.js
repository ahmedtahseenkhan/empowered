...
router.put('/update-profile', authMiddleware_1.authenticateToken, authController_1.updateDisplayName);
router.post('/forgot-password', authController_1.forgotPassword);
router.post('/reset-password', authController_1.resetPassword);
router.post('/verify-email', authController_1.verifyEmail);
router.post('/resend-verification', authController_1.resendVerification);
router.post('/verify-email-code', authController_1.verifyEmailCode);
