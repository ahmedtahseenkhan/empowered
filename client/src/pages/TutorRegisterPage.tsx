...
import {
    Check, X, Shield, CreditCard, Mail,
    Sparkles, Bot, BookOpen, BarChart3, Users, Star, Megaphone, ArrowRight,
} from 'lucide-react';
...
const TutorRegisterPage: React.FC = () => {
    ...
    return (
        <>
        {/* ── Beta confirmation overlay ────────────────────────────────────── */}
        {betaActivated && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(15,10,30,0.75)', backdropFilter: 'blur(6px)' }}>
                <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden">
                    ...
                    <div className="px-8 pb-7 flex flex-col sm:flex-row gap-3">
                        ...
                        <button
                            onClick={() => setBetaActivated(false)}
